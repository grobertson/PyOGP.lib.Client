...
Welcome to the pyogp.lib.client API docs
========================================
...
This set of documents is primarily for use as API documentation for the pyogp.lib.client package. This package contains the client level objects derived from the messaging system data of a client of a Second Life Grid. This package requires pyogp.lib.base, and extends it with convenience functions and classes.
